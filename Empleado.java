...
public class Empleado {
	 ...
	 * @throws Exception en caso de que el nombre del empleado no esté definido correctamente
	 * @deprecated se recomienda utilizar la clase Empleado2 en su lugar
	 * @serial Esta clase es serializable
	 * 
	 * */
